...
def result():
    ...
    print(output)
    name = output["name"]  #     cz109ae
    List =name.split() # friteuse taurus
    length=len(List)
    ...
    print(str(df1.loc[[index][0]][0]))
    print(str(df1.loc[[index][0]][1]))
    ...
    print("\n")
    print("the lower price is :")
    print(str(df2.loc[[index0][0]][0]))
    print(str(df2.loc[[index0][0]][1]))
    print("\n")
    return render_template('index.html', jumia1 = str(df1.loc[[index][0]][0]),jumia2 = str(df1.loc[[index][0]][1]),elec1 = str(df2.loc[[index0][0]][0]),elec2 = str(df2.loc[[index0][0]][1]))
